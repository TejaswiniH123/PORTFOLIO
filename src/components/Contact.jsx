          ...
          >
            ...
            <div className="glass-card rounded-3xl p-7 relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Have a project idea, an internship opportunity, or simply want to connect? I'm always excited to collaborate, learn, and build meaningful software solutions together.
              </p>
            </div>
