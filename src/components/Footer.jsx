      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-14">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="font-bold text-white text-lg leading-tight">Tejaswini H</p>
                <p className="text-gray-500 text-xs">Final Year ISE Student @ NIE Mysore</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Building scalable backend applications and solving real-world problems through clean code, modern technologies, and software engineering.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs flex items-center gap-1.5">
            ...
            <span className="text-gray-300 font-medium">Tejaswini H</span> · {new Date().getFullYear()}
          </p>
