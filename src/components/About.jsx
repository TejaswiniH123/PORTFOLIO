        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['Software Dev', 'QA', 'Backend Dev', 'Researcher','System Design'].map((tag) => (
          ...
          <div>
            ...
            >
              ...
              <div>
                <p className="text-white font-semibold">B.E. in ISE</p>
                <p className="text-gray-400 text-sm">The National Institute of Engineering, Mysore</p>
                <p className="text-primary text-sm font-medium mt-0.5">2023 – 2027 · CGPA 8.96/10</p>
              </div>
            </motion.div>
          </div>
        </div>
